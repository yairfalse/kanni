defmodule Kanni.Plugins.ClaudeDetector do
  @moduledoc """
  ...
  @behaviour Kanni.Plugin.AgentDetector
  ...
  @impl Kanni.Plugin.AgentDetector
  ...
  def handle_info(:poll, state) do
    ...
    if agents_changed?(state.agents, agents) do
      Phoenix.PubSub.broadcast(Kanni.PubSub, "agents", {:agents_changed, agents})
